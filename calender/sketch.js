...
function preload() {
  helvet = loadFont('calender/HelveticaNowDisplayXBlk.otf');
  bodoni = loadFont('calender/BOD.TTF');
  timesNR = loadFont('calender/timesbd.ttf');
  p5Day = loadFont('calender/P5DayOfWeek.ttf');
  weatherImgs = [loadImage('calender/Weather Icons/Sun.png'), loadImage('calender/Weather Icons/Cloud.png'), 
                 loadImage('calender/Weather Icons/Umbrella.png'), loadImage('calender/Weather Icons/Snow.png'),
                 loadImage('calender/Weather Icons/Moon.png')]
